    ...
    <div className={styles.coverCardList}>
      <Card bordered={false}>
        ...
        >
          ...
          >
            <FormItem name="category" style={{marginBottom: 0}}>
          ...
          <StandardFormRow title="其它选项" grid last>
            <Row gutter={16}>
              <Col lg={8} md={10} sm={10} xs={24}>
                <FormItem {...formItemLayout} label="作者" name="author" style={{marginBottom: 0}}>
                  <Select
                    placeholder="不限"
                    style={{
                      maxWidth: 200,
              ...
              <Col lg={8} md={10} sm={10} xs={24}>
                <FormItem {...formItemLayout} label="好评度" name="rate" style={{marginBottom: 0}}>
                  <Select
                    placeholder="不限"
                    style={{
                      maxWidth: 200,
