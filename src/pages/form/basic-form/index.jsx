      ...
      <Card bordered={false}>
        ...
        >
            ...
            rules={[
              {
                required: true,
                message: formatMessage({
                  id: 'formbasicform.date.required',
                }),
              },
            ]}
          >
            <RangePicker
              ...
              placeholder={[
                formatMessage({
                  id: 'formbasicform.placeholder.start',
                }),
                formatMessage({
                  id: 'formbasicform.placeholder.end',
                }),
              ]}
            />
          </FormItem>
            ...
            rules={[
              {
                required: true,
                message: formatMessage({
                  id: 'formbasicform.standard.required',
                }),
              },
            ]}
          >
          ...
          >
            <InputNumber
              placeholder={formatMessage({
                id: 'formbasicform.weight.placeholder',
              })}
              min={0}
              max={100}
            />
            ...
            <div>
              ...
              >
                <Select
                  mode="multiple"
                  placeholder={formatMessage({
                    id: 'formbasicform.publicUsers.placeholder',
                  })}
                  style={{
                    margin: '8px 0',
